...
class Factory {
	...
	protected $fieldTypes = array(
		...
		'textrel' => 'Frozennode\\Administrator\\Fields\\textrel',
		'translations' => 'Frozennode\\Administrator\\Fields\\Translations',
	...
	public function ensureTypeIsSet(array &$options) {
		...
		if (!isset($options['type'])) {
			...
			if ($this->config->getType() === 'model' && $this->config->getDataModel()->getKeyName() === $options['field_name']) {
				$options['type'] = 'key';
			}
